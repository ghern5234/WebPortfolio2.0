...
const Contact = () => {
    return (
        ...
        <div className='flex flex-row mt-20  transition'>
            ...
            <Link to="https://www.linkedin.com/in/ghern5234/"><img src={linkedInImage} width={200} height={250} className='m-2 z-0 rounded-lg transition-all duration-300 hover:scale-110'></img></Link>
